...
alter table product add constraint fk_product_pharmacy_33 foreign key (pharmacy_id) references pharmacy (id);
create index ix_product_pharmacy_33 on product (pharmacy_id);
