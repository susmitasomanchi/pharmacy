...
alter table dcrline_item add constraint fk_dcrline_item_doctor_10 foreign key (doctor_id) references doctor (id);
create index ix_dcrline_item_doctor_10 on dcrline_item (doctor_id);
alter table day_of_the_week add constraint fk_day_of_the_week_doctor_cli_11 foreign key (doctor_clinic_info_id) references doctor_clinic_info (id);
create index ix_day_of_the_week_doctor_cli_11 on day_of_the_week (doctor_clinic_info_id);
alter table diagnostic_center add constraint fk_diagnostic_center_diagnost_12 foreign key (diagnostic_rep_admin_id) references diagnostic_representative (id);
create index ix_diagnostic_center_diagnost_12 on diagnostic_center (diagnostic_rep_admin_id);
alter table diagnostic_representative add constraint fk_diagnostic_representative__13 foreign key (app_user_id) references app_user (id);
create index ix_diagnostic_representative__13 on diagnostic_representative (app_user_id);
alter table diagnostic_representative add constraint fk_diagnostic_representative__14 foreign key (patient_id) references patient (id);
create index ix_diagnostic_representative__14 on diagnostic_representative (patient_id);
alter table diagnostic_test add constraint fk_diagnostic_test_diagnostic_15 foreign key (diagnostic_center_id) references diagnostic_center (id);
create index ix_diagnostic_test_diagnostic_15 on diagnostic_test (diagnostic_center_id);
alter table doctor add constraint fk_doctor_appUser_16 foreign key (app_user_id) references app_user (id);
create index ix_doctor_appUser_16 on doctor (app_user_id);
alter table doctor_assistant add constraint fk_doctor_assistant_appUser_17 foreign key (app_user_id) references app_user (id);
create index ix_doctor_assistant_appUser_17 on doctor_assistant (app_user_id);
alter table doctor_award add constraint fk_doctor_award_doctor_18 foreign key (doctor_id) references doctor (id);
create index ix_doctor_award_doctor_18 on doctor_award (doctor_id);
alter table doctor_clinic_info add constraint fk_doctor_clinic_info_clinic_19 foreign key (clinic_id) references clinic (id);
create index ix_doctor_clinic_info_clinic_19 on doctor_clinic_info (clinic_id);
alter table doctor_clinic_info add constraint fk_doctor_clinic_info_doctor_20 foreign key (doctor_id) references doctor (id);
create index ix_doctor_clinic_info_doctor_20 on doctor_clinic_info (doctor_id);
alter table doctor_clinic_info add constraint fk_doctor_clinic_info_assista_21 foreign key (assistant_id) references doctor_assistant (id);
create index ix_doctor_clinic_info_assista_21 on doctor_clinic_info (assistant_id);
alter table doctor_education add constraint fk_doctor_education_doctor_22 foreign key (doctor_id) references doctor (id);
create index ix_doctor_education_doctor_22 on doctor_education (doctor_id);
alter table doctor_experience add constraint fk_doctor_experience_doctor_23 foreign key (doctor_id) references doctor (id);
create index ix_doctor_experience_doctor_23 on doctor_experience (doctor_id);
alter table doctor_publication add constraint fk_doctor_publication_doctor_24 foreign key (doctor_id) references doctor (id);
create index ix_doctor_publication_doctor_24 on doctor_publication (doctor_id);
alter table doctor_social_work add constraint fk_doctor_social_work_doctor_25 foreign key (doctor_id) references doctor (id);
create index ix_doctor_social_work_doctor_25 on doctor_social_work (doctor_id);
alter table inventory add constraint fk_inventory_pharmacy_26 foreign key (pharmacy_id) references pharmacy (id);
create index ix_inventory_pharmacy_26 on inventory (pharmacy_id);
alter table inventory add constraint fk_inventory_product_27 foreign key (product_id) references product (id);
create index ix_inventory_product_27 on inventory (product_id);
alter table language_app_user add constraint fk_language_app_user_doctor_l_28 foreign key (doctor_language_id) references doctor_language (id);
create index ix_language_app_user_doctor_l_28 on language_app_user (doctor_language_id);
alter table medical_representative add constraint fk_medical_representative_app_29 foreign key (app_user_id) references app_user (id);
create index ix_medical_representative_app_29 on medical_representative (app_user_id);
alter table medical_representative add constraint fk_medical_representative_pha_30 foreign key (pharmaceutical_company_id) references pharmaceutical_company (id);
create index ix_medical_representative_pha_30 on medical_representative (pharmaceutical_company_id);
alter table order_line_item add constraint fk_order_line_item_pharmacy_o_31 foreign key (pharmacy_order_id) references pharmacy_order (id);
create index ix_order_line_item_pharmacy_o_31 on order_line_item (pharmacy_order_id);
alter table order_line_item add constraint fk_order_line_item_product_32 foreign key (product_id) references product (id);
create index ix_order_line_item_product_32 on order_line_item (product_id);
alter table patient add constraint fk_patient_appUser_33 foreign key (app_user_id) references app_user (id);
create index ix_patient_appUser_33 on patient (app_user_id);
alter table pharmacist add constraint fk_pharmacist_appUser_34 foreign key (app_user_id) references app_user (id);
create index ix_pharmacist_appUser_34 on pharmacist (app_user_id);
alter table pharmacist add constraint fk_pharmacist_pharmacy_35 foreign key (pharmacy_id) references pharmacy (id);
create index ix_pharmacist_pharmacy_35 on pharmacist (pharmacy_id);
alter table pharmacy add constraint fk_pharmacy_adminPharmacist_36 foreign key (admin_pharmacist_id) references pharmacist (id);
create index ix_pharmacy_adminPharmacist_36 on pharmacy (admin_pharmacist_id);
alter table prescribed_diagnostic_test add constraint fk_prescribed_diagnostic_test_37 foreign key (prescription_id) references prescription (id);
create index ix_prescribed_diagnostic_test_37 on prescribed_diagnostic_test (prescription_id);
alter table prescribed_medicine add constraint fk_prescribed_medicine_prescr_38 foreign key (prescription_id) references prescription (id);
create index ix_prescribed_medicine_prescr_38 on prescribed_medicine (prescription_id);
alter table product add constraint fk_product_pharmaceutical_com_39 foreign key (pharmaceutical_company_id) references pharmaceutical_company (id);
create index ix_product_pharmaceutical_com_39 on product (pharmaceutical_company_id);
alter table question_and_answer add constraint fk_question_and_answer_questi_40 foreign key (question_by_id) references app_user (id);
create index ix_question_and_answer_questi_40 on question_and_answer (question_by_id);
alter table question_and_answer add constraint fk_question_and_answer_answer_41 foreign key (answer_by_id) references app_user (id);
create index ix_question_and_answer_answer_41 on question_and_answer (answer_by_id);
