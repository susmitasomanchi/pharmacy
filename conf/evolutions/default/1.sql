...
alter table pharmacy add constraint fk_pharmacy_adminPharmacist_53 foreign key (admin_pharmacist_id) references pharmacist (id);
create index ix_pharmacy_adminPharmacist_53 on pharmacy (admin_pharmacist_id);
