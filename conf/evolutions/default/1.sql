...
alter table batch add constraint fk_batch_pharmacyProduct_6 foreign key (pharmacy_product_id) references pharmacy_product (id);
create index ix_batch_pharmacyProduct_6 on batch (pharmacy_product_id);
