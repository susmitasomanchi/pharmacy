...
create table app_user (
  ...
  constraint ck_app_user_blood_group check (blood_group in ('AB-','B+','A-','O-','O+','B-','AB+','A+')),
  constraint ck_app_user_role check (role in ('PATIENT','ADMIN_DIAGREP','DOCTOR','PHARMACIST','MEDNETWORK_ADMIN','ADMIN_PHARMACIST','CLINIC_ADMIN','BLOG_ADMIN','ADMIN_MR','MR','DIAGREP','DOCTOR_SECRETARY')),
...
create table clinic (
  ...
  address_id                bigint,
  clinic_administrator_id   bigint,
...
create table day_schedule (
  ...
  constraint ck_day_schedule_requester check (requester in ('PATIENT','ADMIN_DIAGREP','DOCTOR','PHARMACIST','MEDNETWORK_ADMIN','ADMIN_PHARMACIST','CLINIC_ADMIN','BLOG_ADMIN','ADMIN_MR','MR','DIAGREP','DOCTOR_SECRETARY')),
...
create table feedback (
  ...
  created_on                timestamp not null,
  last_update               timestamp not null,
  constraint ck_feedback_role check (role in ('PATIENT','ADMIN_DIAGREP','DOCTOR','PHARMACIST','MEDNETWORK_ADMIN','ADMIN_PHARMACIST','CLINIC_ADMIN','BLOG_ADMIN','ADMIN_MR','MR','DIAGREP','DOCTOR_SECRETARY')),
...
alter table blood_pressure_tracker add constraint fk_blood_pressure_tracker_app_14 foreign key (app_user_id) references app_user (id);
create index ix_blood_pressure_tracker_app_14 on blood_pressure_tracker (app_user_id);
alter table clinic add constraint fk_clinic_address_15 foreign key (address_id) references address (id);
create index ix_clinic_address_15 on clinic (address_id);
alter table clinic add constraint fk_clinic_clinicAdministrator_16 foreign key (clinic_administrator_id) references clinic_administrator (id);
create index ix_clinic_clinicAdministrator_16 on clinic (clinic_administrator_id);
alter table clinic add constraint fk_clinic_primaryCity_17 foreign key (primary_city_id) references primary_city (id);
create index ix_clinic_primaryCity_17 on clinic (primary_city_id);
alter table clinic_administrator add constraint fk_clinic_administrator_appUs_18 foreign key (app_user_id) references app_user (id);
create index ix_clinic_administrator_appUs_18 on clinic_administrator (app_user_id);
alter table clinic_administrator add constraint fk_clinic_administrator_clini_19 foreign key (clinic_id) references clinic (id);
create index ix_clinic_administrator_clini_19 on clinic_administrator (clinic_id);
alter table dcrline_item add constraint fk_dcrline_item_daily_call_re_20 foreign key (daily_call_report_id) references daily_call_report (id);
create index ix_dcrline_item_daily_call_re_20 on dcrline_item (daily_call_report_id);
alter table dcrline_item add constraint fk_dcrline_item_doctor_21 foreign key (doctor_id) references doctor (id);
create index ix_dcrline_item_doctor_21 on dcrline_item (doctor_id);
alter table dcrline_item add constraint fk_dcrline_item_headQuater_22 foreign key (head_quater_id) references head_quarter (id);
create index ix_dcrline_item_headQuater_22 on dcrline_item (head_quater_id);
alter table daily_call_report add constraint fk_daily_call_report_submitte_23 foreign key (submitter_id) references medical_representative (id);
create index ix_daily_call_report_submitte_23 on daily_call_report (submitter_id);
alter table daily_call_report add constraint fk_daily_call_report_approver_24 foreign key (approver_id) references medical_representative (id);
create index ix_daily_call_report_approver_24 on daily_call_report (approver_id);
alter table daily_call_report add constraint fk_daily_call_report_headQuar_25 foreign key (head_quarter_id) references head_quarter (id);
create index ix_daily_call_report_headQuar_25 on daily_call_report (head_quarter_id);
alter table day_schedule add constraint fk_day_schedule_doctor_clinic_26 foreign key (doctor_clinic_info_id) references doctor_clinic_info (id);
create index ix_day_schedule_doctor_clinic_26 on day_schedule (doctor_clinic_info_id);
alter table designation add constraint fk_designation_pharmaceutical_27 foreign key (pharmaceutical_company_id) references pharmaceutical_company (id);
create index ix_designation_pharmaceutical_27 on designation (pharmaceutical_company_id);
alter table designation add constraint fk_designation_mr_28 foreign key (mr_id) references medical_representative (id);
create index ix_designation_mr_28 on designation (mr_id);
alter table diagnostic_centre add constraint fk_diagnostic_centre_address_29 foreign key (address_id) references address (id);
create index ix_diagnostic_centre_address_29 on diagnostic_centre (address_id);
alter table diagnostic_centre add constraint fk_diagnostic_centre_diagnost_30 foreign key (diagnostic_rep_admin_id) references diagnostic_representative (id);
create index ix_diagnostic_centre_diagnost_30 on diagnostic_centre (diagnostic_rep_admin_id);
alter table diagnostic_centre add constraint fk_diagnostic_centre_primaryC_31 foreign key (primary_city_id) references primary_city (id);
create index ix_diagnostic_centre_primaryC_31 on diagnostic_centre (primary_city_id);
alter table diagnostic_centre_prescription_info add constraint fk_diagnostic_centre_prescrip_32 foreign key (diagnostic_centre_id) references diagnostic_centre (id);
create index ix_diagnostic_centre_prescrip_32 on diagnostic_centre_prescription_info (diagnostic_centre_id);
alter table diagnostic_centre_prescription_info add constraint fk_diagnostic_centre_prescrip_33 foreign key (prescription_id) references prescription (id);
create index ix_diagnostic_centre_prescrip_33 on diagnostic_centre_prescription_info (prescription_id);
alter table diagnostic_centre_prescription_info add constraint fk_diagnostic_centre_prescrip_34 foreign key (shared_by_id) references app_user (id);
create index ix_diagnostic_centre_prescrip_34 on diagnostic_centre_prescription_info (shared_by_id);
alter table diagnostic_order add constraint fk_diagnostic_order_diagnosti_35 foreign key (diagnostic_centre_id) references diagnostic_centre (id);
create index ix_diagnostic_order_diagnosti_35 on diagnostic_order (diagnostic_centre_id);
alter table diagnostic_order add constraint fk_diagnostic_order_prescript_36 foreign key (prescription_id) references prescription (id);
create index ix_diagnostic_order_prescript_36 on diagnostic_order (prescription_id);
alter table diagnostic_report add constraint fk_diagnostic_report_diagnost_37 foreign key (diagnostic_order_id) references diagnostic_order (id);
create index ix_diagnostic_report_diagnost_37 on diagnostic_report (diagnostic_order_id);
alter table diagnostic_report add constraint fk_diagnostic_report_masterDi_38 foreign key (master_diagnostic_test_id) references master_diagnostic_test (id);
create index ix_diagnostic_report_masterDi_38 on diagnostic_report (master_diagnostic_test_id);
alter table diagnostic_representative add constraint fk_diagnostic_representative__39 foreign key (app_user_id) references app_user (id);
create index ix_diagnostic_representative__39 on diagnostic_representative (app_user_id);
alter table diagnostic_representative add constraint fk_diagnostic_representative__40 foreign key (patient_id) references patient (id);
create index ix_diagnostic_representative__40 on diagnostic_representative (patient_id);
alter table diagnostic_representative add constraint fk_diagnostic_representative__41 foreign key (diagnostic_centre_id) references diagnostic_centre (id);
create index ix_diagnostic_representative__41 on diagnostic_representative (diagnostic_centre_id);
alter table diagnostic_test add constraint fk_diagnostic_test_diagnostic_42 foreign key (diagnostic_centre_id) references diagnostic_centre (id);
create index ix_diagnostic_test_diagnostic_42 on diagnostic_test (diagnostic_centre_id);
alter table diagnostic_test_line_item add constraint fk_diagnostic_test_line_item__43 foreign key (prescription_id) references prescription (id);
create index ix_diagnostic_test_line_item__43 on diagnostic_test_line_item (prescription_id);
alter table diagnostic_test_line_item add constraint fk_diagnostic_test_line_item__44 foreign key (master_diagnostic_test_id) references master_diagnostic_test (id);
create index ix_diagnostic_test_line_item__44 on diagnostic_test_line_item (master_diagnostic_test_id);
alter table doctor add constraint fk_doctor_appUser_45 foreign key (app_user_id) references app_user (id);
create index ix_doctor_appUser_45 on doctor (app_user_id);
alter table doctor add constraint fk_doctor_primaryCity_46 foreign key (primary_city_id) references primary_city (id);
create index ix_doctor_primaryCity_46 on doctor (primary_city_id);
alter table doctor_assistant add constraint fk_doctor_assistant_appUser_47 foreign key (app_user_id) references app_user (id);
create index ix_doctor_assistant_appUser_47 on doctor_assistant (app_user_id);
alter table doctor_award add constraint fk_doctor_award_doctor_48 foreign key (doctor_id) references doctor (id);
create index ix_doctor_award_doctor_48 on doctor_award (doctor_id);
alter table doctor_clinic_info add constraint fk_doctor_clinic_info_clinic_49 foreign key (clinic_id) references clinic (id);
create index ix_doctor_clinic_info_clinic_49 on doctor_clinic_info (clinic_id);
alter table doctor_clinic_info add constraint fk_doctor_clinic_info_doctor_50 foreign key (doctor_id) references doctor (id);
create index ix_doctor_clinic_info_doctor_50 on doctor_clinic_info (doctor_id);
alter table doctor_diagnostic_test add constraint fk_doctor_diagnostic_test_doc_51 foreign key (doctor_id) references doctor (id);
create index ix_doctor_diagnostic_test_doc_51 on doctor_diagnostic_test (doctor_id);
alter table doctor_education add constraint fk_doctor_education_doctor_52 foreign key (doctor_id) references doctor (id);
create index ix_doctor_education_doctor_52 on doctor_education (doctor_id);
alter table doctor_experience add constraint fk_doctor_experience_doctor_53 foreign key (doctor_id) references doctor (id);
create index ix_doctor_experience_doctor_53 on doctor_experience (doctor_id);
alter table doctor_product add constraint fk_doctor_product_doctor_54 foreign key (doctor_id) references doctor (id);
create index ix_doctor_product_doctor_54 on doctor_product (doctor_id);
alter table doctor_publication add constraint fk_doctor_publication_doctor_55 foreign key (doctor_id) references doctor (id);
create index ix_doctor_publication_doctor_55 on doctor_publication (doctor_id);
alter table doctor_social_work add constraint fk_doctor_social_work_doctor_56 foreign key (doctor_id) references doctor (id);
create index ix_doctor_social_work_doctor_56 on doctor_social_work (doctor_id);
alter table feedback add constraint fk_feedback_appUser_57 foreign key (app_user_id) references app_user (id);
create index ix_feedback_appUser_57 on feedback (app_user_id);
alter table inventory add constraint fk_inventory_pharmacy_58 foreign key (pharmacy_id) references pharmacy (id);
create index ix_inventory_pharmacy_58 on inventory (pharmacy_id);
alter table inventory add constraint fk_inventory_product_59 foreign key (product_id) references master_product (id);
create index ix_inventory_product_59 on inventory (product_id);
alter table medical_representative add constraint fk_medical_representative_app_60 foreign key (app_user_id) references app_user (id);
create index ix_medical_representative_app_60 on medical_representative (app_user_id);
alter table medical_representative add constraint fk_medical_representative_man_61 foreign key (manager_id) references medical_representative (id);
create index ix_medical_representative_man_61 on medical_representative (manager_id);
alter table medical_representative add constraint fk_medical_representative_pha_62 foreign key (pharmaceutical_company_id) references pharmaceutical_company (id);
create index ix_medical_representative_pha_62 on medical_representative (pharmaceutical_company_id);
alter table medicine_line_item add constraint fk_medicine_line_item_prescri_63 foreign key (prescription_id) references prescription (id);
create index ix_medicine_line_item_prescri_63 on medicine_line_item (prescription_id);
alter table medicine_line_item add constraint fk_medicine_line_item_medicin_64 foreign key (medicine_id) references master_product (id);
create index ix_medicine_line_item_medicin_64 on medicine_line_item (medicine_id);
alter table order_line_item add constraint fk_order_line_item_product_65 foreign key (product_id) references master_product (id);
create index ix_order_line_item_product_65 on order_line_item (product_id);
alter table patient add constraint fk_patient_appUser_66 foreign key (app_user_id) references app_user (id);
create index ix_patient_appUser_66 on patient (app_user_id);
alter table patient add constraint fk_patient_primaryCity_67 foreign key (primary_city_id) references primary_city (id);
create index ix_patient_primaryCity_67 on patient (primary_city_id);
alter table patient_doctor_info add constraint fk_patient_doctor_info_doctor_68 foreign key (doctor_id) references doctor (id);
create index ix_patient_doctor_info_doctor_68 on patient_doctor_info (doctor_id);
alter table patient_doctor_info add constraint fk_patient_doctor_info_patien_69 foreign key (patient_id) references patient (id);
create index ix_patient_doctor_info_patien_69 on patient_doctor_info (patient_id);
alter table pharmaceutical_company add constraint fk_pharmaceutical_company_adm_70 foreign key (admin_mr_id) references medical_representative (id);
create index ix_pharmaceutical_company_adm_70 on pharmaceutical_company (admin_mr_id);
alter table pharmaceutical_product add constraint fk_pharmaceutical_product_pha_71 foreign key (pharmaceutical_company_id) references pharmaceutical_company (id);
create index ix_pharmaceutical_product_pha_71 on pharmaceutical_product (pharmaceutical_company_id);
alter table pharmacist add constraint fk_pharmacist_appUser_72 foreign key (app_user_id) references app_user (id);
create index ix_pharmacist_appUser_72 on pharmacist (app_user_id);
alter table pharmacist add constraint fk_pharmacist_pharmacy_73 foreign key (pharmacy_id) references pharmacy (id);
create index ix_pharmacist_pharmacy_73 on pharmacist (pharmacy_id);
alter table pharmacy add constraint fk_pharmacy_address_74 foreign key (address_id) references address (id);
create index ix_pharmacy_address_74 on pharmacy (address_id);
alter table pharmacy add constraint fk_pharmacy_adminPharmacist_75 foreign key (admin_pharmacist_id) references pharmacist (id);
create index ix_pharmacy_adminPharmacist_75 on pharmacy (admin_pharmacist_id);
alter table pharmacy add constraint fk_pharmacy_primaryCity_76 foreign key (primary_city_id) references primary_city (id);
create index ix_pharmacy_primaryCity_76 on pharmacy (primary_city_id);
alter table pharmacy_info add constraint fk_pharmacy_info_pharmacy_77 foreign key (pharmacy_id) references pharmacy (id);
create index ix_pharmacy_info_pharmacy_77 on pharmacy_info (pharmacy_id);
alter table pharmacy_order add constraint fk_pharmacy_order_prescriptio_78 foreign key (prescription_id) references prescription (id);
create index ix_pharmacy_order_prescriptio_78 on pharmacy_order (prescription_id);
alter table pharmacy_prescription_info add constraint fk_pharmacy_prescription_info_79 foreign key (pharmacy_id) references pharmacy (id);
create index ix_pharmacy_prescription_info_79 on pharmacy_prescription_info (pharmacy_id);
alter table pharmacy_prescription_info add constraint fk_pharmacy_prescription_info_80 foreign key (prescription_id) references prescription (id);
create index ix_pharmacy_prescription_info_80 on pharmacy_prescription_info (prescription_id);
alter table pharmacy_prescription_info add constraint fk_pharmacy_prescription_info_81 foreign key (shared_by_id) references app_user (id);
create index ix_pharmacy_prescription_info_81 on pharmacy_prescription_info (shared_by_id);
alter table pharmacy_product add constraint fk_pharmacy_product_pharmacy_82 foreign key (pharmacy_id) references pharmacy (id);
create index ix_pharmacy_product_pharmacy_82 on pharmacy_product (pharmacy_id);
alter table prescription add constraint fk_prescription_doctor_83 foreign key (doctor_id) references doctor (id);
create index ix_prescription_doctor_83 on prescription (doctor_id);
alter table prescription add constraint fk_prescription_clinic_84 foreign key (clinic_id) references clinic (id);
create index ix_prescription_clinic_84 on prescription (clinic_id);
alter table prescription add constraint fk_prescription_patient_85 foreign key (patient_id) references patient (id);
create index ix_prescription_patient_85 on prescription (patient_id);
alter table prescription add constraint fk_prescription_appointment_86 foreign key (appointment_id) references appointment (id);
create index ix_prescription_appointment_86 on prescription (appointment_id);
alter table question_and_answer add constraint fk_question_and_answer_questi_87 foreign key (question_by_id) references app_user (id);
create index ix_question_and_answer_questi_87 on question_and_answer (question_by_id);
alter table question_and_answer add constraint fk_question_and_answer_answer_88 foreign key (answer_by_id) references app_user (id);
create index ix_question_and_answer_answer_88 on question_and_answer (answer_by_id);
alter table sample add constraint fk_sample_tpline_item_89 foreign key (tpline_item_id) references tpline_item (id);
create index ix_sample_tpline_item_89 on sample (tpline_item_id);
alter table sample add constraint fk_sample_dcrLineItem_90 foreign key (dcr_line_item_id) references dcrline_item (id);
create index ix_sample_dcrLineItem_90 on sample (dcr_line_item_id);
alter table sample add constraint fk_sample_pharmaceuticalProdu_91 foreign key (pharmaceutical_product_id) references pharmaceutical_product (id);
create index ix_sample_pharmaceuticalProdu_91 on sample (pharmaceutical_product_id);
alter table show_cased_product add constraint fk_show_cased_product_pharmac_92 foreign key (pharmacy_id) references pharmacy (id);
create index ix_show_cased_product_pharmac_92 on show_cased_product (pharmacy_id);
alter table show_cased_service add constraint fk_show_cased_service_diagnos_93 foreign key (diagnostic_centre_id) references diagnostic_centre (id);
create index ix_show_cased_service_diagnos_93 on show_cased_service (diagnostic_centre_id);
alter table sig_code add constraint fk_sig_code_doctor_94 foreign key (doctor_id) references doctor (id);
create index ix_sig_code_doctor_94 on sig_code (doctor_id);
alter table sugar_tracker add constraint fk_sugar_tracker_appUser_95 foreign key (app_user_id) references app_user (id);
create index ix_sugar_tracker_appUser_95 on sugar_tracker (app_user_id);
alter table tpline_item add constraint fk_tpline_item_tour_plan_96 foreign key (tour_plan_id) references tour_plan (id);
create index ix_tpline_item_tour_plan_96 on tpline_item (tour_plan_id);
alter table tour_plan add constraint fk_tour_plan_medical_represen_97 foreign key (medical_representative_id) references medical_representative (id);
create index ix_tour_plan_medical_represen_97 on tour_plan (medical_representative_id);
alter table weight_tracker add constraint fk_weight_tracker_appUser_98 foreign key (app_user_id) references app_user (id);
create index ix_weight_tracker_appUser_98 on weight_tracker (app_user_id);
...
drop table if exists blood_pressure_tracker cascade;

drop table if exists clinic cascade;

drop table if exists clinic_administrator cascade;
...
drop table if exists primary_city cascade;
...
drop table if exists sugar_tracker cascade;
...
drop sequence if exists blood_pressure_tracker_seq;
...
drop sequence if exists primary_city_seq;
...
drop sequence if exists sugar_tracker_seq;

drop sequence if exists tpline_item_seq;

drop sequence if exists tour_plan_seq;

drop sequence if exists weight_tracker_seq;
